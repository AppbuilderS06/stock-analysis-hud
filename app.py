...
def main():
    ...
    with st.sidebar:
        ...
        with st.expander("📄 Terms of Use"):
            st.markdown("""
**Stock Analysis HUD — Terms of Use**
*Last updated: March 2026*

**1. Educational Purpose Only**
This tool provides AI-generated stock analysis for educational and informational purposes only. Nothing on this platform constitutes financial advice, investment advice, trading advice, or any other type of advice. You should not treat any content generated by this tool as a recommendation to buy, sell, or hold any security.

**2. No Warranty**
The platform is provided "as is" without warranty of any kind. AI-generated analysis may be inaccurate, incomplete, or out of date. Market data is sourced from third parties and may contain errors. We make no guarantee that any analysis is correct, timely, or suitable for any purpose.

**3. Limitation of Liability**
To the maximum extent permitted by law, the operator of this tool shall not be liable for any financial losses, trading losses, or any other damages arising from your use of, or reliance on, any content generated by this platform. You trade at your own risk.

**4. No Fiduciary Relationship**
Use of this tool does not create a fiduciary, advisory, or professional relationship of any kind between you and the operator.

**5. Regulatory Notice (Canada)**
This tool is not registered with the Autorité des marchés financiers (AMF) or any other securities regulator. It does not provide personalized investment recommendations as defined under applicable securities law.

**6. Third-Party Services**
This platform uses Anthropic's Claude API, yfinance, and Financial Modeling Prep (FMP) data. Your queries may be processed by these third-party services under their respective terms and privacy policies.

**7. Changes**
These terms may be updated at any time. Continued use of the platform constitutes acceptance of the current terms.

By using this tool you confirm that you have read, understood, and agree to these terms.
            """)

        with st.expander("🔒 Privacy Policy"):
            st.markdown("""
**Stock Analysis HUD — Privacy Policy**
*Last updated: March 2026*

**What we collect**
We do not collect, store, or sell any personal information. We do not require account creation or login.

**What third parties may log**
- **Streamlit Cloud** hosts this application and may log usage metadata (page visits, session counts) per their own [Privacy Policy](https://streamlit.io/privacy-policy).
- **Anthropic** processes your ticker queries and any text you submit through their Claude API per their [Privacy Policy](https://www.anthropic.com/privacy).
- **Financial Modeling Prep (FMP)** provides market data per their [Privacy Policy](https://financialmodelingprep.com/privacy-policy).

**Ticker queries**
When you analyze a stock, the ticker symbol and related market data are sent to Anthropic's API to generate the AI analysis. Do not enter personally identifying information into any text field.

**Cookies**
We do not set cookies. Streamlit may use session cookies for technical operation of the app.

**Your rights**
Since we store no personal data, there is nothing to access, correct, or delete on our end. For data held by third-party services, refer to their respective privacy policies linked above.

**Contact**
For privacy questions, use the feedback mechanism on the platform or contact the operator directly.
            """)
...
def render_hud():
    ...
    st.markdown('<div class="hud-footer">NOT FINANCIAL ADVICE · AI-GENERATED · EDUCATIONAL PURPOSES ONLY<br><span style="font-size:9px;color:#374151;">Terms of Use and Privacy Policy available in the sidebar ☰</span></div>', unsafe_allow_html=True)
