...
import anthropicimport streamlit as st
import yfinance as yf
import pandas as pd
import numpy as np
import plotly.graph_objects as go
...
def render_hud():
    ...
    tf_desc   = {
        'Day':      '2–48 hrs · volume, momentum, range',
        'Swing':    '1–8 weeks · trend, phase, OBV',
        'Position': '3–12 months · fundamentals, macro',
    }
    ...
    with c2:
        ...
        <div class="score-card">
          <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:4px;">
            <div style="font-size:9px;color:#64748B;letter-spacing:1px;text-transform:uppercase;">Signal Score</div>
          </div>
          <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:2px;">
            <div style="font-size:10px;color:{score_col};font-weight:700;">{tf_labels[cur_tf]}</div>
          </div>
          ...
          <div class="score-bar-wrap">
            ...
            <div class="score-bar-fill" style="width:{tf_score*10}%;background:{score_col};"></div>
          </div>
          <div class="score-markers"><span>AVOID</span><span>NEUTRAL</span><span>STRONG</span></div>
          <div style="font-size:11px;color:{score_col};font-weight:700;margin-top:5px;">{tf_meaning}</div>
          <div style="font-size:9px;color:#4A6080;margin-top:2px;">{tf_desc[cur_tf]}</div>
        ...
        # Arrow navigation — below score card
        ...
        with a1:
            if st.button("◀", key="tf_prev", use_container_width=True):
                ...
                st.rerun()
        with a2:
            st.markdown(f'<div style="text-align:center;font-size:9px;color:#4A6080;padding-top:6px;">'
                        f'{cur_idx+1}/3</div>', unsafe_allow_html=True)
        with a3:
